...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../BP/BP_test_inference/output/acc_plot_byh.png}
    {\scriptsize Local Train with data\_byh}
  \end{column}
  \begin{column}{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../BP/BP_test_inference/output/acc_plot_fje.png}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../distributed_dnn_on_device/distributed_test/output/plot_fd_leader.png}
    {\scriptsize TODO}
  \end{column}
  \begin{column}{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../distributed_dnn_on_device/distributed_test/output/plot_fd_worker.png}
    {\scriptsize TODO}
  \end{column}
\end{columns}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../BP/BP_test_inference/output/confusion_matrix_mbyh_dbyh.png}
    {\scriptsize Train byh \(\rightarrow\) Test byh\\acc = 82.50\%}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../BP/BP_test_inference/output/confusion_matrix_mbyh_dczh.png}
    {\scriptsize Train byh \(\rightarrow\) Test czh\\ acc = 58.67\%}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../BP/BP_test_inference/output/confusion_matrix_mbyh_dfje.png}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../distributed_dnn_on_device/distributed_test/output/confusion_matrix_databyh.png}
    {\scriptsize FedAvg \(\rightarrow\) Test byh\\acc = 85.00\%}
  \end{column}

  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../distributed_dnn_on_device/distributed_test/output/confusion_matrix_datafje.png}
  ...
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../distributed_dnn_on_device/distributed_test/output/confusion_matrix_dataczh.png}
...
\href{run:demo.mp4}{▶ Click to watch demo video}
