...
\begin{frame}{From Single Board to Federated Setup}
  \begin{itemize}
        ...
        \item Two boards have their own local dataset from different users' gesture recordings.
        \item Network: 
      $75 \rightarrow 32 \rightarrow \text{classes\_cnt}$
     due to the BLE Maximum Transmission Unit
    \item Idea: In each round
      \begin{itemize}
        \item Each board trains locally for every epoch.
