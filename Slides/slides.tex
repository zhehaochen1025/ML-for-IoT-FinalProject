...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    ...
    {\scriptsize Local Train with data_byh}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../BP/BP_test_inference/output/acc_plot_fje.png}
    {\scriptsize Local Train with data_fje}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/curve_fedavg_AB.png}
    {\scriptsize Federated (A+B, FedAvg)}
  \end{column}
\end{columns}
...
\scriptsize
\begin{itemize}
  \item Local training adapts well to its own user/device distribution.
