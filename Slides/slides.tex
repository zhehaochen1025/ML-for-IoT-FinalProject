...
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/curve_local_A.png}
    {\scriptsize Local on Board A}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/curve_local_B.png}
    {\scriptsize Local on Board B}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
...
\begin{frame}{Confusion Matrices: Local Training on Board A}
\centering
\begin{columns}[T,onlytextwidth]
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/cm_Atrain_testA.png}
    {\scriptsize Train A \(\rightarrow\) Test A}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/cm_Atrain_testB.png}
    {\scriptsize Train A \(\rightarrow\) Test B}
  \end{column}
  \begin{column}{0.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/cm_Atrain_testC.png}
    {\scriptsize Train A \(\rightarrow\) Test C}
  \end{column}
\end{columns}
